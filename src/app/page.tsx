      ...
      <main className="flex-1 container mx-auto">
        ...
        <section id="ai-doctor" className="py-8 md:py-12" aria-labelledby="ai-doctor-heading">
          <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="mt-4 text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">Punya keluhan kesehatan? Dapatkan analisis awal dan saran dari asisten dokter kami. Fitur ini tidak menggantikan konsultasi medis profesional.</p>
          </div>
          <div className="mt-8">
            <AIDoctor />
          </div>
